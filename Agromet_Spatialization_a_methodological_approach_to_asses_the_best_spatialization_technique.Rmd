...
In order to ensure science reproductibility ([why it is important](https://www.sevenbridges.com/docker-based-solutions-to-reproducibility-in-science/)), the code is developed in a self-maintained and publicly available [Docker image](https://github.com/pokyah/agrometeorDocker)  
...
* Thanks to exchanges with our partners (you and KNMI + ZEPP + Arvalis) and an extensive review (both in terms of spatial prediction theory and R-coding), 
